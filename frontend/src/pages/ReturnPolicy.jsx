  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: '20px' }}>
        At ShopIn, we proudly stand behind the quality of our merchandise. If for any reason you are completely disastified with your purchase, you may securely initiate a return within 30 days of receiving your order.
      </p>
      ...
      <p style={{ marginBottom: '15px' }}>
        Once your return is physically received and internally inspected, an immediate email protocol will fire notifying you of the approval status. Approved refunds will be returned through the original payment method within 5-7 business working days.
      </p>
